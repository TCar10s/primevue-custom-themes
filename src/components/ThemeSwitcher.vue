<template>
  <div class="flex justify-end p-2 mb-4 card">
            ...
            <div class="inline-flex flex-wrap items-start self-stretch justify-start gap-2">
              <button
                ...
                :style="{
                  ...
                  outlineColor: `${
                    selectedPrimaryColor === primaryColor.name ? 'var(--p-primary-color)' : ''
                  }`
                }"
              ></button>
            </div>
            ...
            <div class="inline-flex items-start self-stretch justify-start gap-2">
              <button
                ...
                :style="{
                  ...
                  outlineColor: `${
                    selectedSurfaceColor === surface.name ? 'var(--p-primary-color)' : ''
                  }`
                }"
              ></button>
            </div>
